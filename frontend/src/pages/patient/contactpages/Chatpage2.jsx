      ...
      >
        {isVoice ? (
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <span role="img" aria-label="microphone" className="text-sm">
                🎤
              </span>
        ...
        <p
          className={`text-xs mt-1 ${
            isUser ? "text-[#a7d0e8]" : "text-gray-500"
          }`}
        >
          {timestamp}
        </p>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-3 bg-gray-50 rounded-2xl px-4 py-3">
          ...
          <input
            ...
            placeholder={
              isListening ? "Recording voice message..." : "Type a message..."
            }
...
const Chatpage2 = ({ patientId, activeConversation, onSaveConversation }) => {
      ...
      activeConversation?.messages || [
        {
          id: "system-1",
          content:
            "Hi there! I'm your medical assistant. How can I help you today?",
    ...
    try {
      ...
      recorder.onstop = async () => {
        ...
        try {
          ...
          const audioFile = new File([blob], "voiceMessage.webm", {
            type: "audio/webm",
          });
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      console.log(data)
      const aiText = data?.answer || "No response from assistant.";
